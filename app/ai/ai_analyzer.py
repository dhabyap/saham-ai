...
Output JSON sesuai format sentiment_prompt.txt"""
    ...
    def _get_default_system_prompt(self):
        return (
            ...
            "PRIMER: Foreign Flow (50%), Accumulation/Distribution (30%) — saham menarik HANYA jika asing atau smart money beli/akumulasi. "
            "SEKUNDER: Relative Strength vs IHSG (10%), Volume (5%), Technical sebagai insight tambahan (5%). "
            "Jika foreign net sell atau tidak ada akumulasi asing → jangan rekomendasi BUY, maksimal HOLD. "
            "'Harga mengikuti uang — uang asing adalah sinyal utama.' "
