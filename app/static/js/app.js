...
createApp({
  setup: function() {
    ...
    return {
      ...
      shSortedTable: shSortedTable, shFilteredOverview: shFilteredOverview, shOverviewQuery: shOverviewQuery, sortTable: sortTable,
 ...
 dominantHolderPct: dominantHolderPct,
 searchStockShareholders: searchStockShareholders,
 selectStockShareholder: selectStockShareholder,
      ...
      clearStockSelection: clearStockSelection,
      ...
      shForceMinPct: shForceMinPct, shForcePortfolio: shForcePortfolio,
      shForcePortfolioLoading: shForcePortfolioLoading,
      ...
      doUploadBrokerPaste: doUploadBrokerPaste,
      clearUploadPaste: clearUploadPaste,
      // Market Reports
