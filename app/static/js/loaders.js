...
async function loadAllData() {
  ...
  var results = await Promise.allSettled([
    cachedFetch('/api/market-summary', 300000),
    cachedFetch('/api/top-gainers?limit=5', 300000),
    cachedFetch('/api/top-losers?limit=5', 300000),
    cachedFetch('/api/top-volume?limit=5', 300000),
    cachedFetch('/api/sector-performance', 600000),
    cachedFetch('/api/day-trade/candidates', 300000),
    cachedFetch('/api/long-term/candidates', 900000),
    cachedFetch('/api/foreign-flow/summary', 900000),
  ]);
  loadShareholders();
